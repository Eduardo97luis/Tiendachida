...
public class Proveedor extends javax.swing.JDialog {
    ...
    public void llenarTabla() {
        ...
        ResultSet datos = conexion.consultas("select * from portillito.proveedor");
        ...
        datos = conexion.consultas("select * from portillito.proveedor order by "+order);
        if (count <= 10) {
            ...
            try {
                while (datos.next()) {
                    ...
                    String razon = datos.getString("razonsocial");
                    String telf = datos.getString("telefono");
                    String email = datos.getString("email");

                    DefaultTableModel mm = (DefaultTableModel) tabla.getModel();
                    mm.addRow(new Object[]{false, id, razon, telf, email});
                }
            } catch (Exception e) {
            }
        } else {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(920, 140, -1, -1));
        ...
        jPanel1.add(buscar, new org.netbeans.lib.awtextra.AbsoluteConstraints(870, 60, 210, -1));
        ...
        jButton5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/tienda2/imagenes/proveedor.png"))); // NOI18N
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        if(activar) {
            ...
            jLabel5.setLocation(jLabel5.getX()+30, jLabel5.getY());
            jLabel6.setLocation(jLabel6.getX()+30, jLabel6.getY());
            jLabel8.setLocation(jLabel8.getX()+30, jLabel8.getY());
        }
        else {
            int cont=0;
            DefaultTableModel mm = (DefaultTableModel) tabla.getModel();
            ...
            if(cont!=0){
                Advertencia ad = new Advertencia(new javax.swing.JFrame(), true, cont,mm,"proveedor","idproveedor");
                ad.setVisible(true);
                activar = true;
                tabla.getColumnModel().getColumn(0).setMaxWidth(0);
                tabla.getColumnModel().getColumn(0).setMinWidth(0);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        this.dispose();
        Recarga cr= new Recarga(new javax.swing.JFrame(),true);
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        ...
        if (contador>=0) {
            ...
            int aux = contador-10;
            ResultSet datos = conexion.consultas("select * from portillito.proveedor order by "+order);
            contador-=20;
